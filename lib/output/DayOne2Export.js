...
function DayOne2Export(options) {
    this.help = {
        name: 'DayOne2Export',
...
DayOne2Export.prototype = Object.create(DefaultPlugin.prototype);

DayOne2Export.prototype.exportDay = function exportDay(day, cb) {
  ...
  if(that.options.directory == 'auto') {
    ...
    that.options.directory = path.join(path.homedir(), 'Library/Group Containers/5U8NS4GX82.dayoneapp2/Data/Auto Import/Default Journal.dayone/');
    ...
    console.log('> Using DayOne2 directory: ' + that.options.directory + '\n');
  }
...
DayOne2Export.prototype.createText = function createText(day) {
    ...
    day.segments.forEach(function(segment) {
        ...
        if(segment.type == 'place') {
            ...
            if(segment.place.type == 'unknown') {
                placeName = '[Unknown place](https://maps.google.com/?q=' + segment.place.location.lat + ',' + segment.place.location.lon + ')';
            }
...
DayOne2Export.prototype.saveEntry = function saveEntry(date, text, mapfile, entry, cb) {
    var that = this;
...
DayOne2Export.prototype.loadEntries = function loadEntries(cb) {
    var that = this;
